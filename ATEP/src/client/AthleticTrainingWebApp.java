//THIS IS GOING TO BE AN ASSESSMENT
package client;
 ...
 */
public class AthleticTrainingWebApp implements EntryPoint {
	/**
	 ...
	 */
	private final AssessmentServiceAsync greetingService = GWT
	...
	public void onModuleLoad() {
		...
		final Button submitButton = new Button("Submit Assessment");
...
//		dialogBox.setWidget(dialogVPanel);
		...
		class MyHandler implements ClickHandler, KeyUpHandler {
			...
			private void sendNameToServer() {
				...
				greetingService.atepServer(textToServer,
